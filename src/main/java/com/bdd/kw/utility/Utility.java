package com.bdd.kw.utility;

import com.bdd.kw.drivermanager.ManageDriver;
...
public class Utility extends ManageDriver {
	...
	/*
	 * This method will switch command from parent to ChildWindow
	 */
	...
	public void switchToChildWindow() {
		...
		for (String str : allOpenWindowHandles) {
			if (!str.equals(parentWindow)) {
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) {
		...
		String destination = System.getProperty("user.dir") + "/src/main/java/com/nopcommerce/demo/screenshots/"
	...
	/*
	 * public void javaExecutorScriptExecuteScriptToTypeText(WebElement
	 * id,String text) {
	...
	/*
	 * public void javaExecutorScriptExecuteScriptToFindHiddenElement(WebElement
	 * element) { js.executeScript("arguments[0].click();", element); }
	 */
	// To perform scroll vertically for 1000px
	/*
	 * public void javaExecutorScriptExecuteScriptToPerformScroll(WebElement
	 * window) { //js.executeScript("window.scrollBy(0,1000)");
	...
	/*
	 * public void javaExecutorScriptExecuteScriptToGetInnerTxt() { String
	 * innerText =
	...
	/*
	 * public void
	 * javaExecutorScriptExecuteScriptToGenerateAlertPopUpWindow(String welMsg)
	 ...
	 * long start = System.currentTimeMillis(); js.
